...
def add_SuperSU():
    ...
    subprocess_call("sudo cp bin/SuperSU/common/Superuser.apk /media/iconia/app/Superuser.apk")
    subprocess_call("sudo cp bin/SuperSU/common/install-recovery.sh /media/iconia/etc/install-recovery.sh")
    subprocess_call("sudo cp bin/SuperSU/armv7/su /media/iconia/xbin/daemonsu")
    subprocess_call("sudo cp bin/SuperSU/armv7/su /media/iconia/xbin/sugote")
    subprocess_call("sudo cp bin/SuperSU/armv7/su /media/iconia/xbin/su")
    subprocess_call("sudo cp bin/SuperSU/armv7/su /media/iconia/bin/.ext/.su")
    subprocess_call("sudo cp /media/iconia/bin/mksh /media/iconia/xbin/sugote-mksh")
    subprocess_call("sudo cp bin/SuperSU/armv7/supolicy /media/iconia/xbin/supolicy")
    subprocess_call("sudo cp bin/SuperSU/armv7/libsupol.so /media/iconia/lib/libsupol.so")
